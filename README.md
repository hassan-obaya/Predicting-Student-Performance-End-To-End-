...
1. Clone the repository: `git clone https://github.com/hassan-obaya/Predicting-Student-Performance-End-To-End-`
2. Navigate to the project directory: `cd Predicting-Student-Performance-End-To-End-`
